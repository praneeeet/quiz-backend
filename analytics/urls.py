...
from .views import UserStatsView, CategoryPerformanceView, QuizStatsView, LeaderboardView, SystemStatsView
...
urlpatterns = [
    ...
    path('analytics/system/', SystemStatsView.as_view(), name='system-stats'),
]
